...
session_start();
    ...
    if($check!=[]){
        ...
        $reserva = '
            <td>'.substr($check[0]->dataCheckin,0,10)." - ".substr($check[0]->dataCheckout,0,10).'</td>
                ...
                <div  class="form__login">
                    ...
                    <table >
                        ...
                        for ($x = 0; $x < sizeof($resproduto); $x++){
                            ...
                            echo "<td>".$resproduto[$x]->qtd." x ".$resproduto[$x]->descricao." R$ ".$resproduto[$x]->valor."</td>";
                            echo "<td>".$resproduto[$x]->valor*$resproduto[$x]->qtd."</td>";
                        ...
                        for ($x = 0; $x < sizeof($resservico); $x++){
                            ...
                            echo "<td>".$resservico[$x]->descricao." R$ ".$resservico[$x]->valor."</td>";
                            echo "<td>".$resservico[$x]->valor."</td>";
